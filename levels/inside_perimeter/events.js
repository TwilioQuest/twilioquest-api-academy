...
module.exports = async function (event, world) {
  ...
  const objectNotifications = {
    ...
    statue_hopper: 'In House Hopper, you will find that knowing how to weild tools is the best way to achieve success. For example, to send auth credentials in an API request in Postman, you must use the Authorization tab. This knowledge will magnify the magic of House Hopper.',
